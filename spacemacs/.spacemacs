  ...
  (setq-default
   ...
   '(
     ...
     (javascript :variables
                 tern-command '("node" "c:/users/<MY_USERNAME>/AppData/Roaming/npm/node_modules/tern/bin/tern"))
     ;; ----------------------------------------------------------------
